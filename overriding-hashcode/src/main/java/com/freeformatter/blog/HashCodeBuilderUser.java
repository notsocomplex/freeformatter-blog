...
/**
 * Example of a User class with a hashCode method that uses more that one field
 * and makes use HashCodeBuilder class from the commons-lang package.
 */
public class HashCodeBuilderUser {
	...
	public HashCodeBuilderUser(final String name, Date dateOfBirth) {
	...
	public boolean equals(Object obj) {
		...
		// argument is null
		if (!(obj instanceof HashCodeBuilderUser)) {
			return false;
		}

		// Cast it to the proper type
		HashCodeBuilderUser other = (HashCodeBuilderUser) obj;
